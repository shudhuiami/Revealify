    ...
    <div style="min-height: 100vh; display: flex; align-items: center; justify-content: center;">
        <div style="max-width: 650px; height: auto; padding: 40px;">
            ...
            <div style="font-weight: bold; text-align: center;">
                <a href="{{route('customer.change.password',['token' => $user->reset_code])}}" style="text-decoration: none; color: #ffffff; background-color: #000000; display: inline-block; padding: 12px 20px; border-radius: 5px;">
                    Change Password
                </a>
            </div>
            <br><br>
