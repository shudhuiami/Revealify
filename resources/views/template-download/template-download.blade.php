...
@section('content')
    <div class="vh-100 d-flex align-items-center justify-content-center download" id="template-download">
        <div class="container text-center">
            <div class="alert alert-success box-content success" v-if="!isWarning">
                ...
                <div class="buttons mt-5">
                    <button class="btn btn-aqua-blue" @click="isWarning = true">Download pdf</button>
                    <button class="btn btn-aqua-blue ms-3" @click="isWarning = true">Save resume</button>
                </div>
            </div>
            <div class="alert alert-warning box-content warning" v-if="isWarning">
