            ...
            <div style="padding: 30px 0 40px 30px; background-color: #404042; border-radius: 0 40px 0 0">
                ...
                <div style="color: #ffffff; margin-bottom: 30px;">
                    <div style="border-bottom: 2px solid #b4b4b6; margin-bottom: 15px;">
                        ...
                        <div
                            style="text-transform: uppercase; margin-left: 10px; font-weight: bold; display: inline-block;position:relative; top: -9px; font-size: 18px;">
                            contact
                        </div>
                    </div>
        ...
        <td style="width: 65%; vertical-align: top;">
            <div style="padding: 30px 0 5px 30px;">
                ...
                <div style="margin-bottom: 40px;">
                    ...
                    <div style="margin-bottom: 10px; font-size: 12px;">
                        <div style="color: #adadad;">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi,
                        ...
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td style="width: 30%; color: #444444; vertical-align: top;">
                                    <div style="margin-bottom: 5px; font-weight: bold;">Graphic Designer</div>
                                    <div>2015 -2017</div>
                                </td>
                            ...
                            <tr>
                                <td style="width: 30%; color: #444444; vertical-align: top;">
                                    <div style="margin-bottom: 5px; font-weight: bold;">Web Designer</div>
                                    <div>2015 -2017</div>
                                </td>
                                <td style="width: 70%; vertical-align: top;">
                            ...
                            <tr>
                                <td style="width: 30%; color: #444444; vertical-align: top;">
                                    <div style="margin-bottom: 5px; font-weight: bold;">Lead Web Designer</div>
                                    <div>2015 -2017</div>
                                </td>
                                <td style="width: 70%; vertical-align: top;">
