...
<table style="width:100%;position:relative;border-collapse: collapse;">
    ...
    <tr>
        ...
        <td style="padding:30px;background-color:#3a3939;overflow: hidden;">
            ...
            <!--user image-->
            <img
                style="width: 166px;height: 166px;object-fit: cover;border:5px solid #fff;margin-left:25px;margin-top: 20px;border-top-left-radius: 90px;border-top-right-radius: 90px;border-bottom-right-radius:90px;position:relative;z-index: 1"
            ...
            <table style="border-left:1px solid #888888;margin-top: 25px;position: relative;color: #fff;">
                ...
                <tr>
                    <td style="padding-left: 20px;padding-top: 20px;position: relative">
                       <span
                        ...
                        <span>+1-718-310-5588</span>
                        <br>
                        <span style="padding-left: 29px">+1-718-310-5588</span>
                    </td>
                </tr>
                <!--Number-->
                ...
                <tr>
                    <td style="padding-left: 20px;padding-top: 20px;position: relative">
                       <span
                        ...
                        <br>
                        <span style="padding-left: 29px">yourinfo@email.com</span>
                    </td>
                </tr>
                <!--Email/website-->
                ...
                <!--Divider-->
                <tr>
                    <td style="padding-top: 20px;padding-bottom:20px;padding-left:20px;position: relative;letter-spacing: 2px">
                        -------------------------------
                    </td>
                </tr>
                <!--Divider-->
                    ...
                    <td style="font-weight: 700;font-size: 18px;padding-left: 20px;text-transform: uppercase">
                       <span
                        ...
                        <img style="margin-right: 5px;width: 24px;height: 24px;position: relative;top: 5px"
                             src="./images/template-1/icon/users.png" alt="users">
                        References
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding-left: 20px;">Tel: +1-718-310-5588</td>
                </tr>

                <tr>
                    <td style="padding-left: 20px;">Email: yourinfo@email.com</td>
                </tr>
                ...
                <tr>
                    <td style="padding-left: 20px;">2011 - 2013</td>
                </tr>
        ...
        <td>
            <div style="position: relative;float: left;width: 100%;margin:0;">
                ...
                <!--User's name and occupation end  -->
                ...
                <table style="border-collapse: collapse;margin-top: 50px">
                    ...
                    <tr>
                        <td style="padding-left: 55px;color:#313030;padding-right: 20px;line-height: 1.5">
                    ...
                    <table style="width:100%;border-collapse: collapse">
                        <tr>
                            ...
                            <td style="text-align: right;width: 100px;padding: 20px 15px 0;">2020
                                - present
                            </td>
                        </tr>
                        <tr>
                            <td style="padding-left: 55px;font-style: italic;">Creative agency / Chicago
                            </td>
                        </tr>
                    </table>
                    ...
                    <table style="width:100%;border-collapse: collapse">
                        <tr>
                            ...
                            <td style="text-align: right;width: 100px;padding: 20px 15px 0;">2015
                                - 2020
                            </td>
                        </tr>
                        <tr>
                    ...
                    <table style="width:100%;border-collapse: collapse">
                        <tr>
                            ...
                            <td style="text-align: right;width: 100px;padding: 20px 15px 0;">2013
                                - 2015
                            </td>
                        </tr>
                        <tr>
